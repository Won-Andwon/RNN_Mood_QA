...
# path = r"/home/chenyongchang/data/dia/train_record_A.txt.zh.vcb.ids40000"
path = r"/home/chenyongchang/data/movie_subtitles_en/movie_subtitles_en_A.txt.zh.vcb.ids40000"
...
if not os.path.exists(path):
    ...
    f_writer = open(r'/home/chenyongchang/data/movie_subtitles_en/bin_group.txt', 'w', encoding="UTF-8")
    v_writer = open(r'/home/chenyongchang/data/movie_subtitles_en/in_group_matrix.txt', 'w', encoding="UTF-8")
    w_writer = open(r'/home/chenyongchang/data/movie_subtitles_en/bin_group_next.txt', 'w', encoding="UTF-8")
