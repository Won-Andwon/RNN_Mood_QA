...
def train_third_module(from_train_id, to_train_id, word_sample_path, vocab_path, para=None):
    if para is None:
        ...
        word_sample_path = r"/home/chenyongchang/data/movie_subtitles_en/train_middle_Q_t.txt"
        ...
        # vocabulary_size = min(len(id2word), 40000)
        # seq2seq_dir = os.path.join(r'/home/chenyongchang/data/movie_subtitles_en/', "seq2seq_test0")
        # saved_model = os.path.join(seq2seq_dir, "seq2seq_model.ckpt")
    else:
    ...
    with tf.Session() as sess:
        model = Seq2SeqModel(vocab_size=vocabulary_size, save_path=seq2seq_dir)
